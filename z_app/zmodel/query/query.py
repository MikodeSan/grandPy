...
class ZQuery:
    ...
    _STOP_WORD_ADDR_FR_LIST_ = ["adresse","situe","situé","située","où est","ou est","trouve","trouvé","cherche","aller","allé","lieu","endroit","coin","spot","connais","connaissez","rendez-vous","rdv", "!", ".", "?", "salut", "hello", "grandpy","grand-père", "papi", "papy", "dis", "aimerais", "sais", "dois"]
